...
***************************************************************************/
PActorPreviewEntity ActorPreviewEntity::PapeNew(PGraphicsObjectBlock pgcb, PTMPL ptmpl, PCOST pcost, long anid, bool fCycleCels, PResourceCache prca)
{
    AssertVarMem(pgcb);
    AssertPo(ptmpl, 0);
...
***************************************************************************/
bool ActorPreviewEntity::_FInit(PTMPL ptmpl, PCOST pcost, long anid, bool fCycleCels, PResourceCache prca)
{
    AssertBaseThis(0);
    AssertPo(ptmpl, 0);
    AssertNilOrPo(pcost, 0);
