...
class SNDV : public SNDV_PAR
{
  ...
  public:
    ...
    virtual long SiiPlay(PRCA prca, ChunkTag ctg, CNO cno, long sqn = ksqnNone, long vlm = kvlmFull, long cactPlay = 1,
...
class SNQUE : public SNQUE_PAR
{
  ...
  protected:
    ...
    virtual PBACO _PbacoFetch(PRCA prca, ChunkTag ctg, CNO cno) = 0;
  ...
  public:
    ...
    void Enqueue(long sii, PRCA prca, ChunkTag ctg, CNO cno, long vlm, long cactPlay, ulong dtsStart, long spr, long scl);
