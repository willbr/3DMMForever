...
class ACTN : public ACTN_PAR
{
  ...
  public:
    ...
    static bool FReadActn(PCRF pcrf, ChunkTag ctg, ChunkNumber cno, PBLCK pblck, PBACO *ppbaco, long *pcb);
    ~ACTN(void);
...
class TMPL : public TMPL_PAR
{
  ...
  public:
    static bool FReadTmpl(PCRF pcrf, ChunkTag ctg, ChunkNumber cno, PBLCK pblck, PBACO *ppbaco, long *pcb);
    ~TMPL(void);
